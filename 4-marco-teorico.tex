...
Desde la perspectiva de la Ingeniería Informática, la \textbf{Tecnología de la Información (TI)} se entiende como el conjunto integrado de infraestructuras, plataformas y servicios tecnológicos que soportan los procesos de negocio y la operación de los sistemas computacionales de una organización. Estos recursos incluyen componentes de hardware, tales como servidores físicos y virtuales, dispositivos de almacenamiento, equipamiento de red y dispositivos móviles, así como componentes de software que abarcan sistemas operativos, bases de datos, aplicaciones empresariales y soluciones web y móviles. En este contexto, los \textbf{Sistemas de Información (SI)} puede plantearse como un conjunto de componentes interrelacionados que recolectan (o recuperan), procesan, almacenan y distribuyen información para apoyar los procesos de toma de decisiones y de control en una organización, ayudando a directores y trabajadores a analizar problemas, visualizar temas complejos y crear nuevos productos o soluciones \parencite{Laudons2021}.
...
Esto demuestra los distintos puntos de vista que se tienen sobre el tema y las diferentes formas de abordarlo, de estas definiciones destaca la de \textcite[562]{Pressman2020}, que define la reingeniería de software como una actividad de reconstrucción sistemática orientada a mejorar sistemas existentes sin descartar su funcionalidad esencial. Aunque implica un costo significativo y un consumo prolongado de recursos, su aplicación resulta estratégica frente a los elevados costos de mantenimiento del software heredado. Mediante el análisis del sistema actual, la comprensión de su arquitectura interna y el rediseño utilizando conceptos modernos, la reingeniería permite facilitar la evolución futura del sistema, incrementar la productividad del desarrollo y reducir los riesgos asociados al cambio, constituyéndose así en una forma de mantenimiento preventivo y evolutivo de largo plazo.
