...
A continuación se presenta una explicación detalla de los flujos principales que aborda SISTAL, junto con el diagrama de flujo respectivo para cada uno.
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.93\textheight]{figuras/diagramas-actuales/dfd-registro-de-tallas.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figuras/diagramas-actuales/dfd-envio-a-confeccion.pdf}
...
% Concluir capitulo con el contexto obtenido de los anteriores, mejoras que se realizarán al sistema y lo que está por venir.
